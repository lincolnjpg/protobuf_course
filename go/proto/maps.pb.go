...
type MapExample2 struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Ids map[string]float32 `protobuf:"bytes,1,rep,name=ids,proto3" json:"ids,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"fixed32,2,opt,name=value,proto3"`
}

func (x *MapExample2) Reset() {
	*x = MapExample2{}
	if protoimpl.UnsafeEnabled {
...
func (x *MapExample2) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MapExample2) ProtoMessage() {}

func (x *MapExample2) ProtoReflect() protoreflect.Message {
	mi := &file_maps_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MapExample2.ProtoReflect.Descriptor instead.
func (*MapExample2) Descriptor() ([]byte, []int) {
	return file_maps_proto_rawDescGZIP(), []int{2}
}

func (x *MapExample2) GetIds() map[string]float32 {
	if x != nil {
		return x.Ids
	}
	return nil
...
var file_maps_proto_rawDesc = []byte{
	...
	,
...
var file_maps_proto_goTypes = []interface{}{
	...
	(*MapExample2)(nil), // 2: example.maps.MapExample2
	nil,                 // 3: example.maps.MapExample.IdsEntry
	nil,                 // 4: example.maps.MapExample2.IdsEntry
}
var file_maps_proto_depIdxs = []int32{
	3, // 0: example.maps.MapExample.ids:type_name -> example.maps.MapExample.IdsEntry
	4, // 1: example.maps.MapExample2.ids:type_name -> example.maps.MapExample2.IdsEntry
	0, // 2: example.maps.MapExample.IdsEntry.value:type_name -> example.maps.IDWrapper
